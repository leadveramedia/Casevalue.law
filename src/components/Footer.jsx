...
export default function Footer({ t, onPrivacyClick, onTermsClick }) {
  return (
    <footer
      className="relative z-10 border-t border-cardBorder mt-20 md:mt-32 py-10 text-center text-textMuted px-4 bg-white min-h-[140px] md:min-h-[120px]"
    ...
    >
      <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-4">
        ...
        <span className="hidden sm:inline text-textMuted/60">|</span>
        <button
