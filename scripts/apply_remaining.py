#!/usr/bin/env python3
"""
Apply the remaining 7 translations to zh.js
"""
import re

# Read the remaining translations
with open('/Users/rshao/casevalue.law/translations_remaining.txt', 'r', encoding='utf-8') as f:
    content = f.read()
...
print(f"Loaded {len(translations)} remaining translations")
