#!/usr/bin/env python3
"""
Apply translations from batch files to zh.js
"""
import re
import sys
...
batch_files = [
    '/Users/rshao/casevalue.law/translations_batch1.txt',
    '/Users/rshao/casevalue.law/translations_batch2.txt',
    '/Users/rshao/casevalue.law/translations_batch3.txt',
    '/Users/rshao/casevalue.law/translations_batch4.txt'
]
...
for batch_file in batch_files:
    ...
    # Extract individual translations using regex
    # Pattern: entry_name: { ... },
    pattern = r'([a-z_]+):\s*\{(.*?)\n\},'
...
print(f"Loaded {len(translations)} translations from batch files")
...
print("Updated zh.js successfully!")
